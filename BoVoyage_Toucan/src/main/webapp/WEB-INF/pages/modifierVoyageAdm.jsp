	...
	<div id="login">
		<form:form method="POST" action="submitUpdateVoyage"
			...
			<div class="form-group">
				<label class="control-label col-sm-2" for="idID">ID</label>
				<div class="col-sm-4">
			...
			<br />
			<div class="form-group">
				<label class="control-label col-sm-2" for="idDdebut">Date de
					debut</label>
				<div class="col-sm-4">
			...
			<br />
			<div class="form-group">
				<label class="control-label col-sm-2" for="idDretour">Date
					de retour</label>
				<div class="col-sm-4">
			...
			<br />
			<div class="form-group">
				<label class="control-label col-sm-2" for="idNbr">Nombre de
					Place</label>
				<div class="col-sm-4">
			...
			<br />
			<div class="form-group">
				<label class="control-label col-sm-2" for="idPrixA">Prix
					Agence</label>
				<div class="col-sm-4">
			...
			<br />
			<div class="form-group">
				<label class="control-label col-sm-2" for="idPrixBV">Prix
					BoVoyage</label>
				<div class="col-sm-4">
			...
			<br />
			<div class="form-group">
				<label class="control-label col-sm-2" for="idAgence">Agence</label>
				<div class="col-sm-4">
			...
			<br />
			<div class="form-group">
				<label class="control-label col-sm-2" for="idCategorieVehicule">CategorieVehicule</label>
				<div class="col-sm-4">
					<form:select path="categorieVehicule.id">
						<c:forEach var="cv" items="${listeCategorieVehicules}"
							varStatus="loop">
			...
			<div class="form-group">
				<label class="control-label col-sm-2" for="idDestination">Destination</label>
				<div class="col-sm-4">
					<form:select path="destination.id">
						<c:forEach var="dest" items="${listeDestinations}"
							varStatus="loop">
							<!--
							<option value="${agences.id}" >${agences}</option>
							-->
			...
			<br />
			<div class="form-group">
				<label class="control-label col-sm-2" for="idFormule">Formule</label>
				<div class="col-sm-4">
			...
			<br />
			<div class="form-group">
				<label class="control-label col-sm-2" for="idLoueurVehicule">LoueurVehicule</label>
				<div class="col-sm-4">
					<form:select path="loueurVehicule.id">
						<c:forEach var="lv" items="${listeLoueurVehicules}"
							varStatus="loop">
							<c:if test="${not loop.first}">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<form:select path="prestation.id">
						<c:forEach var="prest" items="${listePrestations}"
							varStatus="loop">
							<c:if test="${not loop.first}">
