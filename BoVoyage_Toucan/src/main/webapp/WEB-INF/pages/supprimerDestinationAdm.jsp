...
<body>
	...
	<h1 id="titre">Formulaire de suppression d'une destination</h1>
	<br />
	<%@include file="/templates/menuAdm.html"%>


<form:form method="get" action="deleteDestination">
		Id : <input type="number" name="pId" />
		<br />
		<br />
		<input class="btn btn-danger" type="submit" value="supprimer destination">
	</form:form>
