...
<body>
	...
	<div>
		...
		<br/>
		<c:if test="${not null dossier.prestation}"><p>Prestation d'hébérgement : ${dossier.prestation.prestation}</p></c:if>
		<br/>
		...
		<br/>
		<p>Note : votre compte bancaire ne sera débité qu'après vérification par BoVoyage de la validité de votre numéro de carte de crédit.</p>
		<br/>
